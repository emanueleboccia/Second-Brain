...
e la regola di [[docs/web-design/partire-dalla-hero|partire dalla hero]] lo conferma: la hero si
allinea a quello che l'utente ha fatto prima di arrivarci.

**Il pubblico è freddo o tiepido.** Il titolare della zona di solito non sa che il suo foglio
degli ordini si può togliere, e un sito per lui è una commodity. Quindi il copy segue
[[docs/web-design/framework-decomoditizzazione|il framework della decomoditizzazione]]: promessa,
problema, soluzioni che non bastano, spiegazione nuova, e solo alla fine cosa si vende. Il testo
viene da [[self/reference/brand|brand]] e [[self/reference/convinzioni|convinzioni]], con le regole
di [[self/reference/tono|tono]].
...
- **La H1 è il contenuto, non un invito.** «Prima capisco cosa vendi» sta in H1, «Guarda il
  lavoro» sta sul bottone: è la regola di [[docs/web-design/headline-e-paragrafo|headline e
  paragrafo]].
- **Nessun concorrente nominato**, come vuole [[docs/web-design/framework-x-motivi|X motivi]] e
  come vuole la regola sui nemici: si attaccano idee, mai persone.
