...
Aperta il 17/09/2026. Cosa fa il sistema, com'è fatto e cosa manca sta in `sistema.md`, la ricerca del
nome in `nome.md`; qui stanno le decisioni sul progetto, con la data.
