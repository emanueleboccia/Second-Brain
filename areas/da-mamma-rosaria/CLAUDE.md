...
- `regole-editoriali.md` — il mese tipo, la checklist prima di pubblicare, gli undici no, l'export.
...
- `location/spazi.md` — i nomi delle sei sale. Sono nomi propri: non si traducono.
