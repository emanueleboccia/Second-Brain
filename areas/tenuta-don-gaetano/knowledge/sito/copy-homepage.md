---
title: "Copy homepage — Tenuta Don Gaetano"
summary: "Il copy pronto sezione per sezione della home, con i metadati ufficiali del sito e la nota strategica su quale persona e quale dolore risponde ogni blocco."
tags:
  - areas
...
Copy completo, sezione per sezione, mappato sul [[areas/tenuta-don-gaetano/knowledge/sito/sitemap|wireframe]] della home.
Tono: elegante, caldo, evocativo ma concreto. Parla a tutte e tre le [[areas/tenuta-don-gaetano/reference/target|persona]], con la **dimora settecentesca** come filo conduttore e la **richiesta di disponibilità** come obiettivo.
...
> (vedi la regola "Rispetto & consenso" in [[areas/tenuta-don-gaetano/reference/tono|tono di voce]]).
