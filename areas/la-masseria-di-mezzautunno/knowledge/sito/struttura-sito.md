...
summary: "Come è fatto il sito — header e footer fissi, ogni progetto una landing con la sua identità — le regole di scrittura valide per tutte le pagine e l'elenco delle pagine coi rispettivi blueprint."
tags:
  - areas
...
updated: 2026-07-21
related:
  - "[[areas/la-masseria-di-mezzautunno/knowledge/contenuti/dolori-desideri]]"
  - "[[areas/la-masseria-di-mezzautunno/reference/tono]]"
  - "[[areas/la-masseria-di-mezzautunno/knowledge/sito/pagina-home]]"
...
> post-deploy** (testi, accenti, link).
...
- Usa **scarsità, urgenza, FOMO** e i **dolori/desideri/paure del target** — vedi
  [[areas/la-masseria-di-mezzautunno/knowledge/contenuti/dolori-desideri|dolori & desideri]].
...
- Si adatta **al target della pagina**: *tu* caldo per le famiglie, *voi* professionale per le
  scuole (vedi [[areas/la-masseria-di-mezzautunno/reference/tono|tono di voce]]).
...
|---|---|---|
| **Home** | Famiglie (in primis) + smistamento | [[areas/la-masseria-di-mezzautunno/knowledge/sito/pagina-home|blueprint home]] |
| **Scuole** | Maestra Teresa | [[areas/la-masseria-di-mezzautunno/knowledge/sito/pagina-scuole|blueprint scuole]] |
| **Chi siamo** | Tutti | *(da definire — richiamata dalla home)* |
| **Zucche in Masseria** | Famiglie | [[areas/la-masseria-di-mezzautunno/knowledge/sito/template-pagina-progetto|template progetto]] |
