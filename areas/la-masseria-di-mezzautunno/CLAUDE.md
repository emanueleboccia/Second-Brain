...
Su questo sito, **durante un build gli accenti si sono corrotti**. Non è teorico: è successo.
Regola sull'escape unicode: `\uXXXX` sì, `\\uXXXX` mai. Dopo ogni deploy rileggi la pagina
pubblicata: **testi, accenti, link**.
