---
title: "Scheda — Sistema Evolve"
summary: "Sistema Evolve di Vincenzo Campanino: Emanuele e Karim ne sono l'unico reparto marketing, pagato al 10% minimo sulle vendite generate da sito, campagne e social. I materiali operativi vivono nel loro Drive e nel loro Trello, non qui."
tags:
  - entities
  - clienti
  - sistema-evolve
...
# Scheda — Sistema Evolve

## Anagrafica

- **Chi è:** **Vincenzo Campanino**, titolare. Decide lui, e il tavolo è con lui da solo.
- **Karim:** collaboratore. Insieme a Emanuele **è il reparto marketing**, non un fornitore
  esterno. Fa parte della rete: può girare video anche per i brand di famiglia e per il
  personal brand.
- **Attività:** palestre. Il perimetro però è più largo — formazione, consulenze singole da
  1.500 €, una seconda sede in apertura ed eventuali franchise.
- **Stato:** attivo. Non è un cliente ordinario: è una relazione in cui Emanuele sta dentro.
...
- **i social** — Instagram, Facebook, TikTok;
- **il sito web**;
...
| Data | Cosa | Prezzo praticato | Nota |
|---|---|---|---|
...
⚠️ **La roba operativa non sta qui, e non va copiata qui.**

| Cosa | Dove | Chi ce l'ha |
|---|---|---|
| Dati, prezzi loro, design, strategie | Drive `SISTEMA EVOLVE - PALESTRE`, id `1DFBGSAmQfyELdWPliGWxl_MCOINB1Uhf` | **loro** — `ilsistemaevolve@gmail.com` |
| Task e progetti del reparto | Trello, board *Marketing* — https://trello.com/b/J3ASO22b/marketing | **loro** |

**La cartella Drive non è di Emanuele**: è condivisa con lui dal 27/08/2026 e l'accesso è
revocabile. È la ragione per cui questa scheda esiste — quello che deve restargli anche il
giorno che la condivisione sparisce sta scritto qui, non là.

**Su Trello si guarda e basta.** Le modifiche si fanno dal loro cervello aziendale, non da
qui: il briefing del mattino legge le card assegnate a Emanuele e non ne scrive nessuna.
