...
> Come si lavora e come si deploya: `workflow-sito.md`.
...
- Procedura di deploy: `_sistema/tecnica/novamira.md`, sezione «Deploy di file PHP del tema».
...
- **SEO locale:** title/description con "provincia di Napoli", "area vesuviana",
  ...
  ⚠️ Il **titolo SEO dipende da `blogdescription` nel DB**, non dal tema: vedi `workflow-sito.md`.
- **Tracciamento:** pixel/eventi sul form e sui click WhatsApp per misurare i lead da Instagram.
- **Coerenza con Instagram:** stessa palette (toni caldi/dorati), stesse foto cinematografiche,
  link in bio → il sito.
